...
_T: dict[str, dict[str, str]] = {
    "login_failed": {"ru": "Неверный логин или пароль", "kk": "Логин немесе құпиясөз қате", "en": "Invalid login or password"},
    "login_password": {"ru": "Пароль", "kk": "Құпиясөз", "en": "Password"},
    "demo_credentials": {"ru": "Демо сотрудника: E0028 / employee-demo. Демо HR: hr / hr-demo. HR может открыть любой проверочный профиль.", "kk": "Қызметкер демосы: E0028 / employee-demo. HR демосы: hr / hr-demo. HR кез келген тексеру профилін аша алады.", "en": "Employee demo: E0028 / employee-demo. HR demo: hr / hr-demo. HR can open any evaluation profile."},
    "logout": {"ru": "Выйти", "kk": "Шығу", "en": "Log out"},
    "all_skills": {"ru": "Все текущие навыки", "kk": "Барлық ағымдағы дағдылар", "en": "All current skills"},
    "skills_assessment_caption": {"ru": "Последняя оценка с учётом завершённого после неё обучения.", "kk": "Соңғы бағалау және одан кейін аяқталған оқу ескерілген.", "en": "Latest assessment including training completed since that assessment."},
    "demo_notice": {"ru": "Демонстрационный режим · синтетические данные · дата сценария {date}", "kk": "Демо режимі · синтетикалық деректер · сценарий күні {date}", "en": "Demo mode · synthetic data · scenario date {date}"},
    "expected_result": {"ru": "После этого шага", "kk": "Осы қадамнан кейін", "en": "After this step"},
    "expected_caption": {"ru": "Расчёт по правилам датасета; повышение грейда не назначается автоматически.", "kk": "Деректер ережелері бойынша есеп; грейд автоматты түрде көтерілмейді.", "en": "Calculated from dataset rules; grade promotion is not automatic."},
    ...
    "request_error": {"ru": "Не удалось выполнить действие", "kk": "Әрекетті орындау мүмкін болмады", "en": "Unable to complete this action"},
    "go_back": {"ru": "На главную", "kk": "Басты бетке", "en": "Back to home"},
